...
func TestGetFromOverlay(t *testing.T) {
	...
	s.Register("custom.html", []byte("<p>Custom</p>"))

	got, err := s.Get("custom.html")
	if err != nil {
		t.Fatalf("Get() error: %v", err)
	}
...
func TestOverlayOverridesDisk(t *testing.T) {
	...
	s.Register("home.html", []byte("<h1>Overridden</h1>"))
...
func TestListMergesDiskAndOverlay(t *testing.T) {
	...
	s.Register("extra.html", []byte("extra"))
...
func TestRegisterFS(t *testing.T) {
	...
	got, err := s.Get("partials/nav.html")
	if err != nil {
		t.Fatalf("Get() error: %v", err)
	}
...
func TestListOnlyOverlay(t *testing.T) {
	...
	s.Register("overlay.html", []byte("overlay"))
...
func TestListDeduplicatesDiskAndOverlay(t *testing.T) {
	...
	s.Register("home.html", []byte("overlay home"))
